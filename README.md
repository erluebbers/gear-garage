...
in this app, a user logs in to their profile and from their profile, is able to navigate to either the trip page or the gear page. As a user, I can:

Within the trip page:
...
ITEMS belong to Multiple TRIPS and TRIPS have many ITEMS (Many-to-many)
